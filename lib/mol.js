...
class Mol {
  ...
  handleElasticCollision(other) {
    ...
    let final_xvel_this = Util.newVel(this.radius, other.radius, new_xvel_this, new_xvel_other);
    let final_xvel_other = Util.newVel(other.radius, this.radius, new_xvel_other, new_xvel_this);
    let final_yvel_this = new_yvel_this;
    let final_yvel_other = new_yvel_this;
